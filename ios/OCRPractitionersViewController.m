...
-(UITableViewCell *)idCardContent:(UITableViewCell *)cell indexPathRow:(NSInteger)index
{
  if (index == 0) {
    ...
    if (self.idCardImageView == nil) {
      self.idCardImageView = [[UIImageView alloc] initWithFrame:CGRectMake(70, 15, self.view.frame.size.width - 140, (self.view.frame.size.width - 140) * 0.56)];
...
//    UIImage *image = [UIImage imageNamed:value];
    if (self.driverLicenseImageView == nil) {
      self.driverLicenseImageView = [[UIImageView alloc] initWithFrame:CGRectMake(70, 15, self.view.frame.size.width - 140, (self.view.frame.size.width - 140) * 0.56)];
      ...
      [cell addSubview:self.driverLicenseImageView];
...
//    UIImage *image = [UIImage imageNamed:value];
    if (self.qualificationCertificateImageView == nil) {
      self.qualificationCertificateImageView = [[UIImageView alloc] initWithFrame:CGRectMake(70, 15, self.view.frame.size.width - 140, (self.view.frame.size.width - 140) * 0.56)];
      ...
      [cell addSubview:self.qualificationCertificateImageView];
...
//    };
    ...
    if (![positionType isEqual:[NSNull null]]) {
...
//    }
    ...
    if ([drivingLicenseNo isEqual:[NSNull null]]) {
      drivingLicenseNo = @"--";
    }
    NSString *drivingType = [data objectForKey:@"drivingType"];
    if ([drivingType isEqual:[NSNull null]]) {
      drivingType = @"--";
    }
    NSString *drivingStartDate = [data objectForKey:@"drivingStartDate"];
    if ([drivingStartDate isEqual:[NSNull null]]) {
      drivingStartDate = @"--";
    } else {
    ...
    if ([drivingEndDate isEqual:[NSNull null]]) {
      drivingEndDate = @"--";
    } else {
...
{
  if (indexPath.row == 0) {
    return (self.view.frame.size.width - 140) * 0.56 + 30;
  }
  return 44;
}
