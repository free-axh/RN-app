...
//    UIImage *image = [UIImage imageNamed:value];
    UIImageView *imageview = [[UIImageView alloc] initWithFrame:CGRectMake(70, 0, self.view.frame.size.width - 140, (self.view.frame.size.width - 140) * 0.56)];
    ...
    [cell addSubview:self.uploadIdCardBtn];
...
//    UIImage *image = [UIImage imageNamed:value];
    ...
    [cell addSubview:self.uploadDriverLicenseBtn];
    cell.backgroundColor = UIColorFromRGB(0xf4f7fa);
    cell.separatorInset = UIEdgeInsetsMake(0, 0, 0, self.view.frame.size.width);
  } else if (index == 2) {
    NSDictionary *data = [self.driverData objectAtIndex:index];
...
//    UIImage *image = [UIImage imageNamed:value];
    ...
    [cell addSubview:self.uploadQualificationCertificateBtn];
...
{
  if (indexPath.row == 0) {
    return (self.view.frame.size.width - 140) * 0.56;
  }
  return 44;
}
