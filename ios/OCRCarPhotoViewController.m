...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
  ...
  if (indexPath.row == 0) {
    ...
    if (self.carImageView == nil) {
      self.carImageView = [[UIImageView alloc] initWithFrame:CGRectMake(70, 0, self.view.frame.size.width - 140, (self.view.frame.size.width - 140) * 0.56)];
      ...
      [cell addSubview:self.carImageView];
