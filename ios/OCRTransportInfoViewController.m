...
//    UIImage *image = [UIImage imageNamed:value];
    if (self.transportImageView == nil) {
      self.transportImageView = [[UIImageView alloc] initWithFrame:CGRectMake(70, 0, self.view.frame.size.width - 140, (self.view.frame.size.width - 140) * 0.56)];
      ...
      [cell addSubview:self.transportImageView];
