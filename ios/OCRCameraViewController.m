...
-(void)idCardInfoHandle:(id)result
{
  ...
  NSDictionary *nameInfo = [infos objectForKey:@"姓名"];
  NSString *name = [nameInfo objectForKey:@"words"];
  NSDictionary *birthdayInfo = [infos objectForKey:@"出生"];
  NSString *birthday = [birthdayInfo objectForKey:@"words"];
  NSDictionary *cardNumberInfo = [infos objectForKey:@"公民身份号码"];
  NSString *cardNumber = [cardNumberInfo objectForKey:@"words"];
  NSDictionary *genderInfo = [infos objectForKey:@"性别"];
  NSString *gender = [genderInfo objectForKey:@"words"];
  NSDictionary *addressInfo = [infos objectForKey:@"住址"];
  NSString *address = [addressInfo objectForKey:@"words"];
  NSDictionary *nationalInfo = [infos objectForKey:@"民族"];
  NSString *national = [nationalInfo objectForKey:@"words"];
...
- (void)vehicleLicensePositiveInfoHandle:(id)result
{
  NSLog(@"sssss");
  NSDictionary *infos = [result objectForKey:@"words_result"];
  NSDictionary *engineNumberInfo = [infos objectForKey:@"发动机号码"];
  NSString *engineNumber = [engineNumberInfo objectForKey:@"words"];
  NSDictionary *plateNumberInfo = [infos objectForKey:@"号牌号码"];
  NSString *plateNumber = [plateNumberInfo objectForKey:@"words"];
  NSDictionary *ownerInfo = [infos objectForKey:@"所有人"];
  NSString *owner = [ownerInfo objectForKey:@"words"];
  NSDictionary *usingNatureInfo = [infos objectForKey:@"使用性质"];
  NSString *usingNature = [usingNatureInfo objectForKey:@"words"];
  NSDictionary *addressInfo = [infos objectForKey:@"住址"];
  NSString *address = [addressInfo objectForKey:@"words"];
  NSDictionary *registrationDateInfo = [infos objectForKey:@"注册日期"];
  NSString *registrationDate = [registrationDateInfo objectForKey:@"words"];
  NSDictionary *vehicleIdentificationCodeInfo = [infos objectForKey:@"车辆识别代号"];
  NSString *vehicleIdentificationCode = [vehicleIdentificationCodeInfo objectForKey:@"words"];
  NSDictionary *brandModelslInfo = [infos objectForKey:@"品牌型号"];
  NSString *brandModelsl = [brandModelslInfo objectForKey:@"words"];
  NSDictionary *carTypeInfo = [infos objectForKey:@"车辆类型"];
  NSString *carType = [carTypeInfo objectForKey:@"words"];
  NSDictionary *certificateDateInfo = [infos objectForKey:@"发证日期"];
  NSString *certificateDate = [certificateDateInfo objectForKey:@"words"];
...
{
  NSDictionary *infos = [result objectForKey:@"words_result"];
  NSDictionary *quasiTractionTotalQualityInfo = [infos objectForKey:@"准牵引总质量"];
  NSString *quasiTractionTotalQuality = [quasiTractionTotalQualityInfo objectForKey:@"words"];
  NSDictionary *totalQualityInfo = [infos objectForKey:@"总质量"];
  NSString *totalQuality = [[totalQualityInfo objectForKey:@"words"] stringByReplacingOccurrencesOfString: @"kg" withString: @""];
  NSDictionary *approvedLoadMassInfo = [infos objectForKey:@"核定载质量"];
  NSString *approvedLoadMass = [approvedLoadMassInfo objectForKey:@"words"];
  NSDictionary *curbWeightInfo = [infos objectForKey:@"整备质量"];
  NSString *curbWeight = [curbWeightInfo objectForKey:@"words"];
  NSDictionary *fileNumberInfo = [infos objectForKey:@"档案编号"];
  NSString *fileNumber = [fileNumberInfo objectForKey:@"words"];
  NSDictionary *fuelTypeInfo = [infos objectForKey:@"燃油类型"];
  NSString *fuelType = [fuelTypeInfo objectForKey:@"words"];
  NSDictionary *authorizedCapacityInfo = [infos objectForKey:@"核定载人数"];
  NSString *authorizedCapacity = [authorizedCapacityInfo objectForKey:@"words"];
  NSDictionary *verandahSizeInfo = [infos objectForKey:@"外廓尺寸"];
  NSString *verandahSize = [verandahSizeInfo objectForKey:@"words"];
  NSDictionary *inspectionRecordsInfo = [infos objectForKey:@"检验记录"];
  NSString *inspectionRecords = [inspectionRecordsInfo objectForKey:@"words"];
  NSDictionary *noteInfo = [infos objectForKey:@"备注"];
  NSString *note = [noteInfo objectForKey:@"words"];
  NSDictionary *plateNumberInfo = [infos objectForKey:@"号牌号码"];
  NSString *plateNumber = [plateNumberInfo objectForKey:@"words"];
...
-(void)driverLicenseInfoHandle:(id)result
{
  NSLog(@"sssss");
  NSDictionary *infos = [result objectForKey:@"words_result"];
  NSDictionary *quasiDrivingTypeInfo = [infos objectForKey:@"准驾车型"];
  NSString *quasiDrivingType = [quasiDrivingTypeInfo objectForKey:@"words"];
  NSDictionary *cardNumberInfo = [infos objectForKey:@"证号"];
  NSString *cardNumber = [cardNumberInfo objectForKey:@"words"];
  NSDictionary *addressInfo = [infos objectForKey:@"住址"];
  NSString *address = [addressInfo objectForKey:@"words"];
  NSDictionary *nameInfo = [infos objectForKey:@"姓名"];
  NSString *name = [nameInfo objectForKey:@"words"];
  NSDictionary *toInfo = [infos objectForKey:@"至"];
  NSString *to = [toInfo objectForKey:@"words"];
  NSDictionary *genderInfo = [infos objectForKey:@"性别"];
  NSString *gender = [genderInfo objectForKey:@"words"];
  NSDictionary *birthdayInfo = [infos objectForKey:@"出生日期"];
  NSString *birthday = [birthdayInfo objectForKey:@"words"];
  NSDictionary *firstApplicationDateInfo = [infos objectForKey:@"初次领证日期"];
  NSString *firstApplicationDate = [firstApplicationDateInfo objectForKey:@"words"];
  NSDictionary *nationalityInfo = [infos objectForKey:@"国籍"];
  NSString *nationality = [nationalityInfo objectForKey:@"words"];
  NSDictionary *validityDateInfo = [infos objectForKey:@"有效期限"];
  NSString *validityDate = [validityDateInfo objectForKey:@"words"];
...
-(void)qualificationCertificateInfoHandle:(id)result
{
  ...
  for (int i = 0; i < infos.count; i++) {
    ...
    NSString *text = [data objectForKey:@"words"];
    if ([text isEqualToString:@"从业资格"]) {
      int x = i + 1;
      NSString *nextText = [infos[x] objectForKey:@"words"];
      if ([nextText isEqualToString:@"证号"] || [nextText isEqualToString:@"证件号"]) {
        int y = x + 1;
        number = [infos[y] objectForKey:@"words"];
        break;
