...
//    nameLabel.backgroundColor = UIColorFromRGB(0xf4f7fa);
    ...
    if (self.nonFreightCarImageView == nil) {
      self.nonFreightCarImageView = [[UIImageView alloc] initWithFrame:CGRectMake(70, 0, self.view.frame.size.width - 140, (self.view.frame.size.width - 140) * 0.56)];
      ...
      [cell addSubview:self.nonFreightCarImageView];
...
//    UIImage *image = [UIImage imageNamed:value];
    if (self.positiveImageView == nil) {
      self.positiveImageView = [[UIImageView alloc] initWithFrame:CGRectMake(70, 15, self.view.frame.size.width - 140, (self.view.frame.size.width - 140) * 0.56)];
      ...
      [cell addSubview:self.positiveImageView];
...
//    UIImage *image = [UIImage imageNamed:value];
    if (self.reverseImageView == nil) {
      self.reverseImageView = [[UIImageView alloc] initWithFrame:CGRectMake(70, 15, self.view.frame.size.width - 140, (self.view.frame.size.width - 140) * 0.56)];
      ...
      [cell addSubview:self.reverseImageView];
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath
{
  if (tableView.tag == 3) {
    if (indexPath.row == 1) {
      return (self.view.frame.size.width - 140) * 0.56 + 15;
    }
  } else {
    if (indexPath.row == 0) {
