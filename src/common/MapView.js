...
class MapView extends React.Component {
  ...
  render() {
    ...
    // console.warn('sdsdsdsdsd23232323232323', markers);
    ...
    return !pageLayout ? null : (
      <RNTMap
        ...
        onClustersClickEvent={onClustersClickEvent ? data => onClustersClickEvent(data.nativeEvent.data) : null}
        stopPoints={stopPoints}
        stopIndex={stopIndex}
        onStopPointDataEvent={onStopPointDataEvent ? data => onStopPointDataEvent(data.nativeEvent) : null}
        onStopPointIndexEvent={onStopPointIndexEvent ? data => onStopPointIndexEvent(data.nativeEvent) : null}
      />
    );
  }
}

const RNTMap = requireNativeComponent('RCTBaiduMap', null);
