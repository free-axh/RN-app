...
function* initRequest({ payload }) {
  ...
  if (changeSource === 'time') {
    ...
    // console.log('historyLocationResult', historyLocationResult);
    // console.log('mileageDataResult', mileageDataResult);
    // console.log('stopDataResult', stopDataResult);
  ...
  // console.warn('result:', stopDataResult);
