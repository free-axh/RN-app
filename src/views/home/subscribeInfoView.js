...
class SubInfoView extends Component {
  ...
  //   const { basicLocationInfo } = nextProps;
  //   const { basicLocationInfo: preBasicLocationInfo, locationInfoChange } = this.props;
  //   if (basicLocationInfo !== preBasicLocationInfo) {
  //     // console.warn('hhhhhhhhhh');
  //     locationInfoChange();
  //   }
  // }
  ...
  makeSubInfo(data) {
    ...
    if (data !== null) {
      ...
      if (data.gpsTime !== null && data.gpsTime !== undefined && data.gpsTime.length > 0) {
        ...
        // console.warn('jkdkljkdjs', data.gpsTime);
          ...
          <View style={styles.headerInfoFlex}>
            ...
            <View style={styles.flexDirRow}>
              <View style={styles.flexDirRow}>
                ...
                <ScrollView horizontal onContentSizeChange={this.scrollContChange} style={{ maxWidth: '80%' }} ref={(view) => { this.scrollView = view; }}>
                  <View style={{
                    flexDirection: 'row',
                    justifyContent: 'flex-start',
                    alignItems: 'center',
