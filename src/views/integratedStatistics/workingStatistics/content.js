...
import workIcon from '../../../static/image/work.png';
...
export default class WorkingStatisticsContent extends Component {
 ...
 getCheckMonitor=(num, startTimeStr, endTimeStr) => {
  ...
  renderTime=(data) => {
    ...
    return (
      <Text>
        <Text style={styles.maxMinNumber}>
          {data.m}
        </Text>
              m
        <Text style={styles.maxMinNumber}>
          ...
          <View style={styles.block}>
            ...
            <View style={styles.totalContainer}>
              <View style={styles.totalWraper}>
                <Image source={workIcon} resizeMode="contain" style={styles.alarmIcon} />
