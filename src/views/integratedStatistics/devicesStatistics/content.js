...
export default class MileStatisticsContent extends Component {
 ...
 getCheckMonitor=(num, startTimeStr, endTimeStr) => {
  ...
  aggregateData(data) {
    ...
    return {
      totalMileage: toFixed(totalMileage, 1, true),
      ...
      minMileage: toFixed(minMileage, 1, true),
          ...
          <View style={styles.block}>
            ...
            <View style={styles.totalContainer}>
              <View style={styles.totalWraper}>
                <Image source={IconRun} resizeMode="contain" style={styles.alarmIcon} />
                <Text style={styles.totalText}>
                  {getLocale('deviceTotal')}
                  <Text style={styles.totalNumber}>{agg.totalMileage > 9999999.9 ? '>9999999.9' : agg.totalMileage}</Text>
                  {'km'}
                </Text>
              </View>
            </View>
            <View style={styles.totalContainer}>
              <View style={[styles.maxMinContainer, styles.maxContainer]}>
                <Text style={[styles.maxMinText, styles.txtRight]}>
                  {`${getLocale('highest')} `}
                  <Text style={styles.maxMinNumber}>{agg.maxMileage > 99999.9 ? '>99999.9' : agg.maxMileage}</Text>
                  {'km'}
                </Text>
                <Text style={[styles.maxMinText, styles.txtRight]}>
              ...
              <View style={styles.maxMinContainer}>
                <Text style={styles.maxMinText}>
                  {`${getLocale('lowest')} `}
                  <Text style={styles.maxMinNumber}>{agg.minMileage}</Text>
                  {'km'}
                </Text>
                <Text style={styles.maxMinText}>
