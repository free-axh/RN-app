...
import { go, reset, setMonitor } from '../../utils/routeCondition';
...
import { closeSingleSocket } from '../../utils/singleSignOn';
...
const barList2 = [
  {
    leftTit: getLocale('personalCLink5'),
    urlComponent: 'changePassword',
  },
];
...
const barList3 = [
  ...
  {
    leftTit: getLocale('personalCSystemSet'),
    urlComponent: 'systemSetting',
  },
];
...
class PersonalCenter extends Component {
  ...
  static propTypes = {
    ...
    versionData: PropTypes.number.isRequired,
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (versionObj !== {} && versionObj.success && versionObj.obj !== null
      ...
      // console.warn('versionObj', versionObj);
      // this.setState({
      //   versionObj,
      // });
      if (Platform.OS === 'ios') {
        ...
        // console.warn('versionProp', versionProp);
        this.setState({
          appUrl: url,
  ...
  setImgUrl=() => {
    ...
    // console.warn('图片', personalResult);
    if (img) {
      const imgUrl = `${ip}${img}`;
      this.setState({
        imgUrl,
                  ...
                  (!isEmpty(personalResult) && ip)
                    ? (
                      <View style={{ flex: 1 }}>
                        ...
                        />
                        {/* <TouchableHighlight
                          onPress={this.toSystemSetting}
                          underlayColor="transparent"
                        > */}
                        {/* <SingleBar leftTit={getLocale('personalCSystemSet')} /> */}
                        <ListBar barList={barList3} clickFun={this.toListBarClick3} />
                        {/* </TouchableHighlight> */}
                        <ListBar barList={barList} clickFun={this.toListBarClick} />
                        <ListBar barList={barList2} clickFun={this.toListBarClick2} />
