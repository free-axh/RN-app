...
import { getCurAccont, getCheckAlarmType } from '../../../server/getStorageData';
...
static navigationOptions = ({ navigation }) => PublicNavBar(
  ...
  <View style={styles.toggleBox}>
    <Animatable.Text
      animation={navigation.state.params.curState ? '' : 'bounceIn'}
      style={navigation.state.params.curState ? styles.toggleOff : styles.toggleOn}
      onPress={() => { navigation.state.params.toggleState(false); }}
    >
      {getLocale('alarmOff')}
    </Animatable.Text>
    <Animatable.Text
      animation={navigation.state.params.curState ? 'bounceIn' : ''}
      style={navigation.state.params.curState ? styles.toggleOn : styles.toggleOff}
      onPress={() => { navigation.state.params.toggleState(true); }}
    >
      {getLocale('alarmOn')}
    </Animatable.Text>
  </View>,
...
//   header: (
//     <PublicNavBar title={getLocale('alarmSwitchTitle')} nav={navigation}>
//       {/* 导航右侧开关 */}
//       <View style={styles.toggleBox}>
//         <Animatable.Text
//           animation={navigation.state.params.curState ? '' : 'bounceIn'}
...
// })
  ...
  static propTypes = {
    ...
    monitors: PropTypes.object.isRequired, // 监控对象
    getAlarmSetting: PropTypes.func.isRequired, // 获取报警设置数据方法
    settingData: PropTypes.object.isRequired, // 报警设置数据
