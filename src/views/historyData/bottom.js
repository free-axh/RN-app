...
class Bottom extends Component {
    ...
    render() {
      ...
      // console.warn('render:', Math.random());
      ...
      // console.warn(showSwiper, showClock);

      // console.warn(delaySwiper, delayTime);
