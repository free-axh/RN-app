      ...
      <View style={styles.topContainer}>
        ...
        <View style={styles.titleContainer}>
          <Text style={styles.title}>
            {getLocale('addOil')}
            <Text style={styles.titleActive}> {toFixed(totalAddOil, 1, true)} </Text>
            <Text style={styles.titleUnit}>L</Text>
          </Text>
          <Text style={styles.title}>
            {getLocale('reduceOil')}
            <Text style={styles.titleActive}> {toFixed(totalReduceOil, 1, true)} </Text>
            <Text style={styles.titleUnit}>L</Text>
          </Text>
          <Text style={styles.title}>
            {getLocale('useOil')}
            <Text style={styles.titleActive}> {toFixed(totalUseOil, 1, true)} </Text>
            <Text style={styles.titleUnit}>L</Text>
          </Text>
        </View>
      </View>
