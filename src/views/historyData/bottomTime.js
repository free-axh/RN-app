    ...
    return (
      <View style={styles.container}>
        {/* <DatePicker
            ...
            is24Hour
            cancelBtnText={getLocale('startTimeText')}
            style={styles.dateElement}
            ref={(ref) => { this.startDatePickerRef = ref; }}
          ...
          <DatePicker
            ...
            format="YYYY-MM-DD HH:mm"
            is24Hour
            cancelBtnText={getLocale('endTimeText')}
            style={styles.dateElement}
            ref={(ref) => { this.endDatePickerRef = ref; }}
            onDateChange={this.handleEndDateChange}
            onCloseModal={this.handleEndCloseModal}
            locale="zh-CN"
