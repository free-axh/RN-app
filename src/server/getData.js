 ...
 * 登录接口
 */
export const postLogin = async data => fetch(`/clbs/oauth/token?client_id=mobile_1&client_secret=secret_1&grant_type=password&username=${data.username}&password=${data.password}`, 'POST', data, 8000, false);

/**
 * 强制更新接口
 */
export const ifMustUpdate = async data => fetch(`/clbs/app/update/force?version=${data.version}&platform=${data.platform}`, 'POST', data, 8000, false);

/**
 * 平台版本检测
 */
export const getHighest = async data => fetch('/clbs/app/update/highest', 'POST-FORM', data, 8000, false);

/**
 * 中寰登录接口
 */
export const postLoginZhonghuan = async data => fetch(`/clbs/oauth/token?client_id=mobile_1&client_secret=secret_1&grant_type=password&username=${data.username}&password=${data.password}&verificationCode=${data.verificationCode}`, 'POST', data, 8000, false);
 ...
 * 获取监控对象分组
 */
export const getAssignment = data => fetch('/clbs/app/monitor/assignmentByUser', 'GET', data);
