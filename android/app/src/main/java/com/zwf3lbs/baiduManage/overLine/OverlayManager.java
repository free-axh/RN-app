package com.zwf3lbs.baiduManage.overLine;
...
public abstract class OverlayManager implements OnMarkerClickListener, OnPolylineClickListener {
    ...
    public final void addToMap() {
        ...
        for (OverlayOptions option : mOverlayOptionList) {
            ...
            if (overlay.getExtraInfo() != null) {
                ...
                if (overlay.getExtraInfo().getString("last").equals("true")) {
    ...
    public void zoomToSpan() {
        ...
        if (mOverlayList.size() > 0) {
            ...
            int mapHeight = ScreenUtils.getScreenHeight() - SizeUtils.dp2px(50) - SizeUtils.dp2px(BaiduMapVariable.footerHeight);
            // 移动中心点
