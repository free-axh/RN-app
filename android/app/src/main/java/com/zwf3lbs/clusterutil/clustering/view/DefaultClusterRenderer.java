...
package com.zwf3lbs.clusterutil.clustering.view;
...
import com.zwf3lbs.clusterutil.clustering.Cluster;
import com.zwf3lbs.clusterutil.clustering.ClusterItem;
import com.zwf3lbs.clusterutil.clustering.ClusterManager;
import com.zwf3lbs.clusterutil.projection.Point;
import com.zwf3lbs.clusterutil.projection.SphericalMercatorProjection;
import com.zwf3lbs.clusterutil.ui.IconGenerator;
...
import com.zwf3lbs.clusterutil.ui.SquareTextView;
...
//        BitmapDescriptor bitmapDescriptor  = BitmapDescriptorFactory.fromResource(R.drawable.cluster);
    ...
    private class CreateMarkerTask {
        ...
        private void perform(MarkerModifier markerModifier) {
            ...
            List<MonitorInfo> monitorInfos = new LinkedList<>();
            for (T t: items) {
