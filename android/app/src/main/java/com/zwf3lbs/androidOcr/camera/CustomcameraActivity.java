package com.zwf3lbs.androidOcr.camera;
...
public class CustomcameraActivity extends Activity implements SurfaceHolder.Callback {
    ...
    private ImageButton openPicButton;
    ...
    private Camera.PictureCallback mpictureCallback=new Camera.PictureCallback(){
        ...
        public void onPictureTaken(byte[] data,Camera camera){
            File tempfile = new File("/sdcard/ocr.png");//新建一个文件对象tempfile，并保存在某路径中
            try {
    ...
    protected void onCreate( Bundle savedInstanceState) {
        ...
        // 取消按钮
        cancelButton = findViewById(R.id.orc_cancel);
        // 图库按钮
        openPicButton  = findViewById(R.id.ocr_open_picture);
        // 闪光灯
        openLightButton = findViewById(R.id.ocr_open_light);
        takePictureButton = findViewById(R.id.ocr_take_picture);
        //点击预览界面聚焦
