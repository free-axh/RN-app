...
public class ConfirmVehicleActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(applicationData.getProfessionalType() != null && applicationData.getProfessionalType().equals(applicationData.getIcProfessionalType()) && !applicationData.isAddProfessional()) {
